...
struct ContentView: View {
    ...
    */
    ...
    let principles = [
        ...
        "ruThirdPrince" : "3. Будьте абсолютно непредубежденным3.1. Осознайте два мешающих вам барьера.a. Ваше эго как барьер.b. Два ваших «я» сражаются за контроль над вами.c. Ваша «слепая зона» как барьер.3.2. Придерживайтесь принципа абсолютной непредубежденности.a. Признайте, что вы можете не знать лучшего возможного способа действий и что ваша способность справиться с тем, чего вы не знаете, важнее, чем то, что вы знаете.b. Процесс принятия решения состоит из двух этапов: сначала получите всю относящуюся к делу информацию, затем принимайте решение.c. Не волнуйтесь, что о вас подумают. Волнуйтесь, как достичь цели.d. Чтобы отдавать, нужно принимать.e. Чтобы увидеть ситуацию глазами другого человека, нужно на время воздержаться от критики. Только эмпатия поможет вам правильно оценить чужую точку зрения.f. Ищите лучшее решение, а не лучшее решение, на которое вы способны.g. Отдавайте себе отчет, пытаетесь вы дискутировать или понять точку зрения другого человека. Подумайте, что будет полезнее, оценив уровень компетентности (и свой, и чужой).3.3. Научитесь искусству продуктивного несогласия.3.4. Проверяйте свое мнение в общении с несколькими компетентными людьми, которым вы доверяете и которые готовы высказывать противоположную точку зрения.a. Планируйте худший сценарий, чтобы сделать его настолько хорошим, насколько это возможно.3.5. Научитесь распознавать непредубежденных и предубежденных людей.3.6. Узнайте, как достичь абсолютной непредубежденности.а. Воспринимайте боль как руководство для качественных размышлений.b. Сделайте непредубежденность привычкой.c. Определите свои «слепые зоны».»d. Если несколько компетентных людей утверждают, что вы ошибаетесь, а вы единственный, кто не разделяет это мнение, скорее всего, вы действительно ошибаетесь.e. Медитируйте.f. Опирайтесь на факты и стимулируйте к этому других.g. Делайте все, что в ваших силах, чтобы помочь другим повысить уровень непредубежденности.h. Используйте инструменты для принятия решений с учетом фактов и доказательств.i. Научитесь понимать, в какой момент лучше перестать настаивать на своем мнении.",


        "ruFourPrince" : "4. Примите тот факт, что люди «запрограммированы» по-разному4.1. Поймите, какие преимущества вы получите, если будете знать, как «запрограммированы» вы и другие люди»a. Человек рождается с характеристиками, которые способны как помочь ему, так и помешать, в зависимости от их применения.4.2. Осмысленные работа и отношения – это не только выбор человека, это запрограммировано генетически.4.3. Узнайте, какие битвы идут у вас в голове и как их контролировать, чтобы получить желаемое.a. Ваше сознание и подсознание находятся в состоянии постоянного противоборства.b. Между чувствами и рациональным мышлением происходит непрекращающаяся борьба.c. Научитесь соотносить свои чувства и рациональное мышление.d. Выбирайте привычки с умом.e. Для формирования правильных привычек обучайте свое низшее «я» с добротой и настойчивостью»f. Узнайте, чем разнится мышление людей с доминирующим правым или левым полушарием.g. Узнайте, в какой степени мозг способен или не способен меняться.4.4. Разберитесь, что представляете собой вы и другие.a. Интроверсия vs. экстраверсия.b. Интуиция vs. ощущение.c. Мышление vs. чувства.d. Планирование vs. восприятие.e. Созидатели vs. улучшатели vs. продвигатели vs. исполнители vs. адапторы.f. Концентрация на задачах vs. концентрация на целях.g. Оценка личностных качеств на рабочем месте (Workplace Personality Inventory).h. Лидер способен проделать путь от визуализации до воплощения в жизнь.»4.5. Ключ к успеху в любом деле – правильные люди на своих местах.a. Управляйте собой и другими для достижения цели.",


        "ruFivePrince" : "5. Научитесь эффективно принимать решения5.1. Наибольший вред эффективному процессу принятия решений наносят эмоции; процесс принятия решений состоит из двух этапов: сначала анализ, потом решение.5.2. Составьте объективное представление о ситуации.a. Одно из самых важных решений, которое вы можете принять, – это к кому обращаться за информацией.b. Не верьте всему, что слышите.c. Вблизи все кажется больше.d. Новинки переоценены в сравнении с классикой.e. Не преувеличивайте важность точек.5.3. Составьте представление о долгосрочном развитии ситуации.a. Одновременно оценивайте скорость изменений, уровень, на котором находится цель, и соотношение между ними.b. Позвольте себе быть не совсем точным.c. Руководствуйтесь правилом 80/20 и отдавайте себе отчет, что составляет 20 %.d. Не будьте перфекционистом.5.4. Эффективно действуйте на разных уровнях.a. Используйте условные понятия «над чертой» и «под чертой», чтобы определить уровень, на котором ведется разговор.b. Решение должно приниматься на соответствующем уровне, но быть согласованным на всех.5.5. Логика, рациональное мышление и здравый смысл – ваши лучшие инструменты для объективной оценки реальности и понимания, что с ней делать.5.6. Принимайте решения на основе расчета ожидаемой выгоды.a. Всегда полезно повысить свою вероятность оказаться правым, независимо от того, каково положение дел сейчас.b. Знать, когда отказаться от «ставки», не менее важно, чем знать, когда «ставку» стоит сделать.c. Лучший выбор всегда тот, в котором больше «за», чем «против», а не тот, в котором нет «против».5.7. Определяйте приоритеты, оценивая важность дополнительной информации по отношению к цене откладывания решения.a. В первую очередь следует делать то, что вы должны, а затем уже то, что вам нравится.b. Есть вероятность, что у вас не хватит времени на мелочи. Это лучше, чем когда времени не хватает на что-то важное.c. Не следует путать возможности и вероятность.5.8. Упрощайте!5.9. Следуйте принципам.5.10. Соотносите свои решения с мнением компетентных людей.5.11. Сформулируйте принципы в формате алгоритмов, чтобы компьютер принимал решения параллельно с вами.5.12. Не стоит полагаться на искусственный интеллект, если у вас нет глубокого понимания процесса.»",
